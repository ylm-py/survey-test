...
export const GenreSection = (props) => {
  const [genre, setgenre] = useState({ genre:props.title,comment: "", tracksRatings: [] });
  ...
  const handlecomment=(e)=>{
    ...
    ne.tracksCount = tracks.length
    setgenre(ne)
  }
 
  if(validate){
    let survey=info
    survey.userRatings.push(genre)
    survey.userRatings = [...new Set(survey.userRatings)]
